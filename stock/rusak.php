...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sbrg_masuk set tgl='$tanggal',jumlah='$jumlah',kondisi='$kondisi',keterangan='$keterangan' where id='$id'");
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="rusak.php">Barang Rusak / Hilang</a></li>
                                </ul>  
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Barang Rusak / Hilang</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Barang Kondisi Rusak / Hilang</h2>
                                </div>
