                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="bagus.php">Barang Bagus / Utuh</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Barang Kondisi Bagus / Utuh</h2>
                                </div>
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											<?php 
											$brg=mysqli_query($conn,"SELECT * from sstock_brg where kondisi='Bagus' or kondisi='Utuh' order by idx DESC");
											$no=1;
									...
									<a href="exportbrgbgs.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
