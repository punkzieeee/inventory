                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="index.php"><i class="ti-pencil-alt"></i><span>Notes</span></a></li>
                            <li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        ...
                                        $reminder=mysqli_query($conn,"select * from sbrg_keluar sb, sstock_brg st, sgrouping sg where st.idx=sb.idx and sb.idx=sg.idx and sb.idg=sg.idg and sb.status='Keluar' and DATEDIFF(sb.kembali, CURDATE()) <= 0");
                                        while($p=mysqli_fetch_array($reminder)){  
                                            echo "<tr bgcolor='red' id='lewat'>
                                            <td><center>".$i."</center></td>
                                            <td><center>Barang <strong><u>".$p['nama_brg']." ".$p['serial_brg']." (".$p['serial'].")</u></strong> sudah melewati batas peminjaman tanggal <strong><u>".date("d-M-Y", strtotime($p['kembali']))."</u></strong></center></td>
                                            <td><strong><center>Sistem</center></strong</td>
                                            <td></td></tr>";  
                                            $i++;    
                                        }
